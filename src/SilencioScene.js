class SilencioScene extends Phaser.Scene {
    ...
    create() {
        ...
        backButton.on('pointerdown', () => this.scene.start('HubScene', { nivel2Abierto: true, nivel3Abierto: true, nivel3Completado: true, desde: 'nivel3' }));
    }
    ...
    mostrarTrivial(indice) {
        ...
        if (datos.foto) {
            fotoObj = this.add.image(185, 150, datos.foto).setDisplaySize(130, 170).setScrollFactor(0).setDepth(22);
        } else {
    ...
    mostrarPiezaPuzzle() {
        ...
        btnOk.on('pointerdown', () => this.scene.start('HubScene', { nivel2Abierto: true, nivel3Abierto: true, nivel3Completado: true, desde: 'nivel3' }));
    }
